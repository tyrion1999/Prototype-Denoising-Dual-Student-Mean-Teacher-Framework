...
class LA_heart(Dataset):
    ...
    def __init__(self, base_dir=None, split='train', num=None, transform=None):
        ...
        #test_path = '/home/stu/zy/data/ACDC/data'+'/test.list'
    ...
    def __getitem__(self, idx):
        ...
        # ACDC
        #h5f = h5py.File(self._base_dir + "/{}.h5".format(image_name), 'r')
        image = h5f['image'][:] # image(10,256,208)
        label = h5f['label'][:] # label(10,256,208)
...
class RandomCrop(object):
    ...
    def __call__(self, sample):
        image, label = sample['image'], sample['label'] # image (152,224) label:(154,224) |
        if self.with_sdf:
            sdf = sample['sdf']
...
class RandomRotFlip(object):
    ...
    def __call__(self, sample):
        ...
        return {'image': image, 'label': label,'imageA': image,'imageB': image}
